...
namespace FlirThermalLib {
	...
	public unsafe partial class FLIRIdentity : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public FLIRIdentity (string serial)
			: base (NSObjectFlag.Empty)
		{
			var nsserial = NSString.CreateNative (serial);
			
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
			if (IsDirectBinding) {
				InitializeHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("initWithFlirOneSerialNo:"), nsserial), "initWithFlirOneSerialNo:");
			} else {
				InitializeHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper_IntPtr (this.SuperHandle, Selector.GetHandle ("initWithFlirOneSerialNo:"), nsserial), "initWithFlirOneSerialNo:");
			}
			NSString.ReleaseNative (nsserial);
