...
namespace FlirThermalLib {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "CameraFound", Selector = "cameraFound:", ParameterType = new Type [] { typeof (FlirThermalLib.FLIRIdentity) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DiscoveryError", Selector = "discoveryError:netServiceError:on:", ParameterType = new Type [] { typeof (string), typeof (int), typeof (FlirThermalLib.FLIRCommunicationInterface) }, ParameterByRef = new bool [] { false, false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "CameraLost", Selector = "cameraLost:", ParameterType = new Type [] { typeof (FlirThermalLib.FLIRIdentity) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DiscoveryFinished", Selector = "discoveryFinished:", ParameterType = new Type [] { typeof (FlirThermalLib.FLIRCommunicationInterface) }, ParameterByRef = new bool [] { false })]
...
namespace FlirThermalLib {
	[Protocol()]
	[Register("ApiDefinition__FlirThermalLib_FLIRDiscoveryEventDelegate", false)]
	[Model]
