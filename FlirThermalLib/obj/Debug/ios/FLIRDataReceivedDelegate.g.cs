...
namespace FlirThermalLib {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "OnConnectionStatusChanged", Selector = "onConnectionStatusChanged:Status:withError:", ParameterType = new Type [] { typeof (FlirThermalLib.FLIRCamera), typeof (FlirThermalLib.FLIRConnectionStatus), typeof (NSError) }, ParameterByRef = new bool [] { false, false, false })]
...
namespace FlirThermalLib {
	[Protocol()]
	[Register("ApiDefinition__FlirThermalLib_FLIRDataReceivedDelegate", false)]
	[Model]
