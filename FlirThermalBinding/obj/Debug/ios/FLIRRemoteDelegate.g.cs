...
namespace FlirThermalBinding {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ChargingStateChanged", Selector = "ChargingStateChanged:", ParameterType = new Type [] { typeof (FlirThermalBinding.FLIRChargingState) }, ParameterByRef = new bool [] { false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "LastStoredImageChanged", Selector = "LastStoredImageChanged:", ParameterType = new Type [] { typeof (FlirThermalBinding.LastStoredImage_t) }, ParameterByRef = new bool [] { false })]
...
namespace FlirThermalBinding {
	[Protocol()]
	[Register("ApiDefinition__FlirThermalBinding_FLIRRemoteDelegate", false)]
	[Model]
