...
namespace ObjCRuntime {
	...
	static partial class Trampolines {
		...
		[UserDelegateType (typeof (global::FlirThermalBinding.FLIRThermalImageBlock))]
		...
		static internal class SDFLIRThermalImageBlock {
			...
			static unsafe void Invoke (IntPtr block, IntPtr arg0) {
				...
				var del = (global::FlirThermalBinding.FLIRThermalImageBlock) (descriptor->Target);
				if (del != null)
					del ( Runtime.GetNSObject<FlirThermalBinding.FLIRThermalImage> (arg0));
			}
		...
		internal sealed class NIDFLIRThermalImageBlock : TrampolineBlockBase {
			...
			[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			public unsafe static global::FlirThermalBinding.FLIRThermalImageBlock Create (IntPtr block)
			{
				if (block == IntPtr.Zero)
					return null;
				var del = (global::FlirThermalBinding.FLIRThermalImageBlock) GetExistingManagedDelegate (block);
				return del ?? new NIDFLIRThermalImageBlock ((BlockLiteral *) block).Invoke;
			}
			
			[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			unsafe void Invoke (global::FlirThermalBinding.FLIRThermalImage arg0)
			{
