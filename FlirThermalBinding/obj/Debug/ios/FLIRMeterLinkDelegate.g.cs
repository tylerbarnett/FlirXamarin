...
namespace FlirThermalBinding {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DeviceDiscovered", Selector = "deviceDiscovered:", ParameterType = new Type [] { typeof (FlirThermalBinding.FLIRMeterLinkDevice) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DeviceDisappeared", Selector = "deviceDisappeared:", ParameterType = new Type [] { typeof (FlirThermalBinding.FLIRMeterLinkDevice) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DeviceConnected", Selector = "deviceConnected:", ParameterType = new Type [] { typeof (FlirThermalBinding.FLIRMeterLinkDevice) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DeviceDisconnected", Selector = "deviceDisconnected:", ParameterType = new Type [] { typeof (FlirThermalBinding.FLIRMeterLinkDevice) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DeviceUpdated", Selector = "deviceUpdated:", ParameterType = new Type [] { typeof (FlirThermalBinding.FLIRMeterLinkDevice) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "MlState", Selector = "mlState:", ParameterType = new Type [] { typeof (FlirThermalBinding.FLIRMeterLinkState) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DataRecordingReceived", Selector = "dataRecordingReceived:data:CSVString:", ParameterType = new Type [] { typeof (FlirThermalBinding.FLIRMeterLinkDevice), typeof (NSObject), typeof (string) }, ParameterByRef = new bool [] { false, false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "ImageReceived", Selector = "imageReceived:image:", ParameterType = new Type [] { typeof (FlirThermalBinding.FLIRMeterLinkDevice), typeof (NSData) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "TransferProgress", Selector = "transferProgress:filetype:progressCurrent:progressTotal:", ParameterType = new Type [] { typeof (FlirThermalBinding.FLIRMeterLinkDevice), typeof (FlirThermalBinding.FLIRMeterLinkFileType), typeof (int), typeof (int) }, ParameterByRef = new bool [] { false, false, false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "ParserError", Selector = "parserError:parseError:", ParameterType = new Type [] { typeof (FlirThermalBinding.FLIRMeterLinkDevice), typeof (FlirThermalBinding.FLIRMeterLinkParseError) }, ParameterByRef = new bool [] { false, false })]
...
namespace FlirThermalBinding {
	[Protocol()]
	[Register("ApiDefinition__FlirThermalBinding_FLIRMeterLinkDelegate", false)]
	[Model]
