...
namespace FlirThermalBinding
{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRIpSettings
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRCameraInformation
	{
	...
	public interface FLIRIdentity
	{
		...
		//IntPtr Constructor([NullAllowed] string serial);//TODO THIS NEED ADD LATER
	}

	// @protocol FLIRRemoteDelegate <NSObject>
	[Protocol, Model(AutoGeneratedName = true)]
	[BaseType(typeof(NSObject))]
	public interface FLIRRemoteDelegate
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRCalibration
	{
		// -(BOOL)isActive;
		[Export("isActive")]
		// [Verify (MethodToProperty)]
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRRemoteControl
	{
		[Wrap("WeakDelegate")]
		[NullAllowed]
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRImageBase
	{
		// -(int)getWidth;
		[Export("getWidth")]
		// [Verify (MethodToProperty)]
	...
	[BaseType(typeof(NSObject))]
	[DisableDefaultCtor]
	public interface FLIRMeasurementParameters
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRMeasurementShape
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRThermalValue
	{
	...
	public interface FLIRMeasurementSpot
	{
	...
	[BaseType(typeof(FLIRMeasurementShape))]
	public interface FLIRMeasurementMarker
	{
	...
	public interface FLIRMeasurementArea
	{
	...
	public interface FLIRMeasurementRectangle
	{
	...
	[BaseType(typeof(FLIRMeasurementArea))]
	public interface FLIRMeasurementCircle
	{
		// @property (readwrite) CGPoint position;
		[Export("position", ArgumentSemantic.Assign)]
		CGPoint Position { get; set; }
	...
	[BaseType(typeof(FLIRMeasurementMarker))]
	public interface FLIRMeasurementLine
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRMeasurementCollection
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRPaletteManager
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRImageParameters
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRImageStatistics
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRCameraDeviceInfo
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRCameraEvent
	{
	...
	[Protocol, Model(AutoGeneratedName = true)]
	[BaseType(typeof(NSObject))]
	public interface FLIRCameraImportEventDelegate
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRFileObject
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRCameraImport
	{
	...
	[Protocol, Model(AutoGeneratedName = true)]
	[BaseType(typeof(NSObject))]
	public interface FLIRDiscoveryEventDelegate
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRDiscovery
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRMeterLinkDeviceInfo
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRMeterLinkDeviceChannel
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRMeterLinkDevice
	{
	...
	[Protocol, Model(AutoGeneratedName = true)]
	[BaseType(typeof(NSObject))]
	public interface FLIRMeterLinkDelegate
	{
	...
	[BaseType(typeof(NSObject))]
	public interface FLIRMeterLinkManager
	{
	...
	public interface FLIRThermalImageFile
	{
	...
	partial interface Constants
	{
		...
		IntPtr MeterLinkVersionString { get; }
